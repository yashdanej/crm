            ...
            <form class="w-full max-w-lg bg-gray-50 p-5 rounded-3xl">
                <div class="w-full mb-6">
                    <div class="w-full md:w-[20rem] xl:w-full px-3 mb-6 md:mb-0">
                        ...
                        <input onChange={(event) => changeText(event, setStatus, status)} class="appearance-none block w-full bg-gray-200 text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="grid-first-name" type="text" name='name' placeholder="Jane"/>
