...
import { getDesignation, get_Group } from '../../../../store/slices/SetupSlices';
import { api } from '../../../../utils/Utils';
import { useDispatch, useSelector } from 'react-redux';

const GroupTable = ({handleEdit}) => {
    ...
    const groupData = useSelector(state => state.setup.setupGroup);
    const handleDelete = (id) => {
        api(`/util/grp/${id}`, "delete", false, false, true)
        .then((res) => {
